...
public class IntcodeProgam  {
	...
	public IntcodeProgam  ( int  nom  ,int sortie ,  String i_line , long i_phase_setting  , int i_input  ){
		
		System.out.println(" start =  ampli "  + i_line) ;
